      ...
      <main className="max-w-4xl mx-auto px-6 py-12 pt-32">
        ...
        <div className="max-w-none space-y-8">
          ...
          <section>
            ...
            <h3 className="text-lg font-medium mb-3 opacity-90">Personal Information</h3>
            <p className="leading-relaxed opacity-70 mb-4">
              We may collect personal information that you voluntarily provide, including:
            </p>
            <ul className="list-disc list-inside opacity-70 space-y-2 ml-4 mb-6">
            ...
            <h3 className="text-lg font-medium mb-3 opacity-90">Automatically Collected Information</h3>
            <p className="leading-relaxed opacity-70 mb-4">
          ...
          <section>
            ...
            <p className="leading-relaxed opacity-70 mt-4">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4">12. International Transfers</h2>
            <p className="leading-relaxed opacity-70">
      ...
      <footer className={`border-t mt-16 ${isDark ? 'border-white/10' : 'border-black/10'}`}>
        <div className="max-w-4xl mx-auto px-6 py-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link href="/tos" className={`text-sm transition-colors ${isDark ? 'text-white/40 hover:text-white' : 'text-black/40 hover:text-black'}`}>
              Terms of Service
            </Link>
          </div>
        </div>
